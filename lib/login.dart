...
//  form
  ...
  final _tinNumberController = new TextEditingController();
                                ...
                                if (entrep)
                                  InputContainer(
                                    ...
                                    validator: (value) {
                                      ...
                                      // Check if the TIN number has exactly 12 digits
                                      if (value.length != 12) {
                                        return 'TIN Number must be exactly 12 digits';
                                      }

                                      // Check if the TIN number contains only digits
                                      if (!value
                                          .contains(RegExp(r'^\d{12}$'))) {
